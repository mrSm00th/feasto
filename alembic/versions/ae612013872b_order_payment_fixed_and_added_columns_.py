...
def upgrade() -> None:
    ...
    sa.Enum("STRIPE", "RAZORPAY", "COD", name="paymentprovider").create(
        op.get_bind(), checkfirst=True
    )

    # order_items
    op.add_column(
        "order_items", sa.Column("item_description", sa.Text(), nullable=True)
    )
    ...
    op.add_column(
        "orders",
        sa.Column(
            "delivery_latitude", sa.Numeric(precision=10, scale=7), nullable=True
        ),
    )
    op.add_column(
        "orders",
        sa.Column(
            "delivery_longitude", sa.Numeric(precision=10, scale=7), nullable=True
        ),
    )
    op.add_column(
        "orders", sa.Column("customer_name", sa.String(length=120), nullable=False)
    )
    op.add_column(
        "orders", sa.Column("customer_phone", sa.String(length=20), nullable=True)
    )
    op.add_column(
        "orders", sa.Column("customer_email", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "orders",
        sa.Column(
    ...
    op.add_column(
        "orders", sa.Column("cancellation_note", sa.String(length=500), nullable=True)
    )
    op.add_column(
        "orders", sa.Column("confirmed_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "orders", sa.Column("preparing_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "orders", sa.Column("ready_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "orders",
        sa.Column("rider_assigned_at", sa.DateTime(timezone=True), nullable=True),
    )
    op.add_column(
        "orders", sa.Column("picked_up_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        "orders",
    ...
    op.add_column(
        "payments", sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
...
def downgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "payment_provider",
            postgresql.ENUM("STRIPE", "RAZORPAY", "COD", name="paymentprovider"),
            autoincrement=False,
            nullable=False,
        ),
    )
    op.add_column(
        "payments",
        sa.Column(
            "currency", sa.VARCHAR(length=10), autoincrement=False, nullable=False
        ),
    )
    op.add_column(
        "payments",
