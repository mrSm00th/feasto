...
#     DEACTIVAETED = "DEACTIVATED" # user deactivaed their account, can be reactivated by user
#     SUSPENDED = "SUSPENDED " # admin level action, can be reactivated by admin after review
...
#         foreign_keys="OwnerApplication.user_id",
#     )
